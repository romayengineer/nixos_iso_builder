...
- **Build command**: `nix build .#bootDebugISO.config.system.build.isoImage`
...
- **NixOS version**: Pin to `nixos-25.05` or stable branch for reproducibility
...
- **Correct command**: `nix build .#bootDebugISO.config.system.build.isoImage`
