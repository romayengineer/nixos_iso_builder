      ...
      # Helper function to create a boot ISO with a specific logging profile
       ...
       mkBootISO = (profileName:
         let
           ...
           # Build the NixOS system with the selected logging profile
          ...
          # Extract the actual ISO image builder derivation
           # .config.system.build.isoImage is the derivation that builds the ISO
